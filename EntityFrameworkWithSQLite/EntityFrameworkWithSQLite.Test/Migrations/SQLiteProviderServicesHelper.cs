...
{
    static class SQLiteProviderServicesHelper
    {

        /// <summary>
        /// Creates a SQLiteParameter given a name, type, and direction
        /// </summary>
        internal static SQLiteParameter CreateSQLiteParameter(string name, TypeUsage type, ParameterMode mode, object value)
        {
            int? size;
            ...
            DbType sqlDbType = GetSQLiteDbType(type, isOutParam, out size);
